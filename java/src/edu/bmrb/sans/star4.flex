 ...
 * All Rights Reserved.
 *
 * FILE:        $Source: /cvs_archive/cvs/starlibs5/sans/src/edu/bmrb/sans/star4.flex,v $
 * 
 * AUTHOR:      $Author: dmaziuk $
 * DATE:        $Date: 2006/02/11 02:28:57 $
 * 
 * UPDATE HISTORY:
 * ---------------
 * $Log: star4.flex,v $
 * Revision 1.1  2006/02/11 02:28:57  dmaziuk
 * updated
 *
...
<YYINITIAL> {
    ...
    {STOP} { return STOP; }
//    {COMMENT} {NON_NL}* / {NL} { return COMMENT; }  
