...
class TestSequenceFunctions(unittest.TestCase):
    ...
    # TODO: This could probably use some checks of the parser - but that is really on Dimitri
    def test___entryParser(self):
        self.assertRaises(ValueError, bmrb._entryParser)
    ...
    def test_saveframe(self):
        ...
        self.assertEqual(frame.getTag("entry.sf_category", whole_tag=True), [['Sf_category', 'entry_information']])

        # Test sort
        self.assertEqual(frame.tags, [['Sf_category', 'entry_information'], ['Sf_framecode', 'entry_information'], ['ID', '15000'], ['Title', 'Solution structure of chicken villin headpiece subdomain containing a fluorinated side chain in the core\n'], ['Type', 'macromolecule'], ['Version_type', 'original'], ['Submission_date', '2006-09-07'], ['Accession_date', '2006-09-07'], ['Last_release_date', '.'], ['Original_release_date', '.'], ['Origination', 'author'], ['NMR_STAR_version', '3.1.1.61'], ['Original_NMR_STAR_version', '.'], ['Experimental_method', 'NMR'], ['Experimental_method_subtype', 'solution'], ['BMRB_internal_directory_name', '.'], ['example1', 5], ['example2', '.']])
