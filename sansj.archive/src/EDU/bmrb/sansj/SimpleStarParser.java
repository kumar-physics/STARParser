 ...
 *
 * Created on July 16, 2003, 3:32 PM
 *
 * This software is copyright (c) 2002 Board of Regents, University of Wisconsin.
 * All Rights Reserved.
 *
 * FILE:        $Source: /cvs_archive/cvs/sansj/src/EDU/bmrb/sansj/SimpleStarParser.java,v $
 * 
 ...
 * UPDATE HISTORY:
 * ---------------
 * $Log: SimpleStarParser.java,v $
 * Revision 1.1  2006/04/03 22:40:41  dmaziuk
 * bug fix in lex specs.
 *
 * Revision 1.5  2005/11/10 00:17:38  dmaziuk
 * *** empty log message ***
 *
 * Revision 1.4  2004/03/03 23:11:45  dmaziuk
 * fixed a bug in comment parsing
 *
 * Revision 1.3  2003/08/01 17:45:34  dmaziuk
 * bugfix: value without tag/tag without value is an error
 *
 * Revision 1.2  2003/07/30 20:17:04  dmaziuk
 * fixed minor bug in multi-line comment handling
 *
...
//*******************************************************************************
     ...
     * @param lex scaner
     */
    public SimpleStarParser( STARLexer lex ) {
        fLex = lex;
    } //*************************************************************************
     ...
     */
    public SimpleStarParser( STARLexer lex, StarContentHandler ch, ErrorHandler eh ) {
        fLex = lex;
        fCh = ch;
        fEh = eh;
    } //*************************************************************************
    ...
    public boolean parseSaveFrame() {
        ...
        try {
            do {
			    ...
			    if( fLex.getText().indexOf( newline ) == 0 )
			        val.setValue( fLex.getText().substring( newline.length() ) );
    ...
    */
    public static void main (String args[]) {
        try {
            ...
            SimpleStarParser p = new SimpleStarParser( lex );
            p.test_parse();
        }
        catch( Exception e ) { e.printStackTrace(); }
    } //*************************************************************************
